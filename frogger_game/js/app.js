...
Player.prototype.shufflePlayer = function () {
   this.sprite = this.sprite != 'images/char-boy.png' ? 'images/char-boy.png' : 'images/char-cat-girl.png';
};
...
Player.prototype.handleInput = function(keyPress) {
    ...
    if (keyPress == 'left') {
        // instead of 'player' use the keyword 'this' to rever to the current object
        // this.x -= this.speed;
        this.x -= this.speed;
    }
    if (keyPress == 'up') {
